    ...
    <section>
      ...
      <form method="post" action="signup.php">
        ...
        <div class="form-control">
          ...
          <input type="text" name="firstName" id="firstName" aria-required="false" maxlength="256"/>
        </div>
        <div class="form-control">
          <label for="lastName">Last Name</label>
          <input type="text" name="lastName" id="lastName" aria-required="false" maxlength="256"/>
        </div>
